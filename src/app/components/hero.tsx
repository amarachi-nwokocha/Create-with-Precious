...
const HeroSection = () => {
  ...
  return (
    <div className="relative backdrop-blur-[2px]">
      <motion.section
        className="relative min-h-screen flex items-center justify-center px-2 md:px-10 py-24"
              ...
              >
                <div className="block md:flex gap-5">
                  ...
                  <motion.button
                    ...
                    className="px-8 mt-8 md:mt-0 py-4 bg-[#5B1E1B] md:text-lg shadow-lg rounded text-white"
                    variants={buttonVariants}
                    whileHover="hover"
                    whileTap="tap"
                  >
...
//       <iframe
//         title="vimeo-player"
//         src="https://player.vimeo.com/video/1099027457?h=b1d59afffc&autoplay=1&muted=1&background=1"
//         frameBorder="0"
